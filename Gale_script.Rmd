...
# 0.0.1 revisions Sep 2024 
# 0.0.2 revisions Jun 2025
# 0.0.3 revisions Aug 2025
...
pcoa_manyvar_noellipse <- function(folder_name = folder_name, mapper_file = mapper_file, title_name_add = title_name_add, legend_position = legend_position,pco1=1,pco2=2,shape_var = shape_var,color_var = color_var,fill_var = fill_var,circle_var = circle_var, linetype_var = linetype_var, plot_shapes = plot_shapes, plot_fills = plot_fills, plot_colors = plot_colors, plot_ellipses = plot_ellipses, circle_color = "black", legend_name = NULL, legend_label = NULL) {
...
```{sh}
# name=conant
# biom convert -i otu_out_manual_""$name.txt -o cfu_asv_table_$name"".biom --to-hdf5 --table-type="OTU table"
# qiime tools import --input-path cfu_asv_table_$name"".biom --type 'FeatureTable[Frequency]' --input-format BIOMV210Format --output-path cfu_asv_table_$name"".qza
# bash ~/Dropbox/sequencing/16sscripts/bray_curtis.sh cfu_asv_table_$name"" conant_test1 2500 cfu_mapper_$name"".tsv "filtercol = 'Y'" 

i=conant_test1
mkdir $i
mkdir $i""/bray_curtis_dm_conant_test1
mkdir $i""/core-metrics-results-conant_test1/
mkdir $i""/core-metrics-results-conant_test1/bray_curtis_distance_matrix
wget -O $i""/core-metrics-results-conant_test1/bray_curtis_distance_matrix/distance-matrix.tsv https://raw.githubusercontent.com/johnchaston/Gale2024/main/conant_test1/core-metrics-results-conant_test1/bray_curtis_distance_matrix/distance-matrix.tsv
wget -O conant_test1/bray_curtis_dm_conant_test1/distance-matrix.tsv https://raw.githubusercontent.com/johnchaston/Gale2024/main/conant_test1/bray_curtis_dm_conant_test1/distance-matrix.tsv


wget -O cfu_mapper_conant.tsv https://raw.githubusercontent.com/johnchaston/Gale2024/main/cfu_mapper_conant.tsv
wget -O otu_out_manual_conant.txt https://raw.githubusercontent.com/johnchaston/Gale2024/main/otu_out_manual_conant.txt
wget -O cfu_data.tsv https://raw.githubusercontent.com/johnchaston/Gale2024/main/cfu_data.tsv
pwd
```
...
mkdir core-metrics-results-redo2009m2/unweighted_unifrac_pcoa_results/
wget -O core-metrics-results-redo2009m2/unweighted_unifrac_pcoa_results/ordination.txt https://raw.githubusercontent.com/johnchaston/Gale2024/main/core-metrics-results-redo2009m2/unweighted_unifrac_pcoa_results/ordination.txt
mkdir core-metrics-results-redo2009m2/weighted_unifrac_pcoa_results/
wget -O core-metrics-results-redo2009m2/weighted_unifrac_pcoa_results/ordination.txt https://raw.githubusercontent.com/johnchaston/Gale2024/main/core-metrics-results-redo2009m2/weighted_unifrac_pcoa_results/ordination.txt
mkdir core-metrics-results-redo2009m2/bray_curtis_pcoa_results/
wget -O core-metrics-results-redo2009m2/bray_curtis_pcoa_results/ordination.txt https://raw.githubusercontent.com/johnchaston/Gale2024/main/core-metrics-results-redo2009m2/bray_curtis_pcoa_results/ordination.txt
...
amberflies <- base_plot +
  ...
  coord_flip() + 
  labs(x = NULL, y = "Fractional abundance")
...
prep_taxon_plot_numbersfirst(file_path = file_path, map_path = map_path, plotvarnames = plotvarnames, mapper_file = mapper_file, taxonomic_level=taxonomic_level, rpa_in_chart = rpa_in_chart, read_depth = read_depth, legend_position=legend_position,  sort_x_axis = sort_x_axis,  x_cluster = x_cluster, predefined_taxa = predefined_taxa, predefined_shortname = predefined_shortname)[[3]] %>% filter(Var1 == "k__Bacteria_ p__Firmicutes_ c__Bacilli_ o__Lactobacillales") %>% dplyr::pull(perc)
...
amberpoints <- ggplot(points_data %>% filter(plot=="amber"), aes(x = column, y = row, shape = symbol)) +   geom_point(size = 2) + scale_shape_identity() +   theme_cowplot() +  theme(legend.position = "none")+   xlim(c(0.88,1.12)) + ylim(c(1,11.1))
  ...
  ## plot by cornstage only
shape_var = "latitude"
color_var = "latitude"
fill_var = "latitude"
circle_var = "latitude"
linetype_var = "latitude"
plot_shapes <- points_data %>% filter(plot == "amber") %>% arrange(desc(sortorder)) %>% pull(symbol)
plot_fills <- c(rep("black",6))
plot_colors <- c(rep("black",6))
...
mkdir core-metrics-results-flies_mantel2o2/bray_curtis_pcoa_results
mkdir core-metrics-results-flies_mantel2o2/unweighted_unifrac_pcoa_results
mkdir core-metrics-results-flies_mantel2o2/weighted_unifrac_pcoa_results
...
wget -O core-metrics-results-flies_mantel2o2/unweighted_unifrac_pcoa_results/ordination.txt https://raw.githubusercontent.com/johnchaston/Gale2024/refs/heads/main/core-metrics-results-flies_mantel2o2/bray_curtis_pcoa_results/ordination.txt
wget -O core-metrics-results-flies_mantel2o2/bray_curtis_pcoa_results/ordination.txt https://raw.githubusercontent.com/johnchaston/Gale2024/refs/heads/main/core-metrics-results-flies_mantel2o2/bray_curtis_pcoa_results/ordination.txt
wget -O core-metrics-results-flies_mantel2o2/unweighted_unifrac_pcoa_results/ordination.txt https://raw.githubusercontent.com/johnchaston/Gale2024/refs/heads/main/core-metrics-results-flies_mantel2o2/unweighted_unifrac_pcoa_results/ordination.txt
wget -O core-metrics-results-flies_mantel2o2/weighted_unifrac_pcoa_results/ordination.txt https://raw.githubusercontent.com/johnchaston/Gale2024/refs/heads/main/core-metrics-results-flies_mantel2o2/weighted_unifrac_pcoa_results/ordination.txt
...
mkdir core-metrics-results-flies_mantel2v2/bray_curtis_pcoa_results
mkdir core-metrics-results-flies_mantel2v2/unweighted_unifrac_pcoa_results
mkdir core-metrics-results-flies_mantel2v2/weighted_unifrac_pcoa_results
...
wget -O core-metrics-results-flies_mantel2v2/unweighted_unifrac_pcoa_results/ordination.txt https://raw.githubusercontent.com/johnchaston/Gale2024/refs/heads/main/core-metrics-results-flies_mantel2v2/bray_curtis_pcoa_results/ordination.txt
wget -O core-metrics-results-flies_mantel2v2/bray_curtis_pcoa_results/ordination.txt https://raw.githubusercontent.com/johnchaston/Gale2024/refs/heads/main/core-metrics-results-flies_mantel2v2/bray_curtis_pcoa_results/ordination.txt
wget -O core-metrics-results-flies_mantel2v2/unweighted_unifrac_pcoa_results/ordination.txt https://raw.githubusercontent.com/johnchaston/Gale2024/refs/heads/main/core-metrics-results-flies_mantel2v2/unweighted_unifrac_pcoa_results/ordination.txt
wget -O core-metrics-results-flies_mantel2v2/weighted_unifrac_pcoa_results/ordination.txt https://raw.githubusercontent.com/johnchaston/Gale2024/refs/heads/main/core-metrics-results-flies_mantel2v2/weighted_unifrac_pcoa_results/ordination.txt
...
henryorchard <- base_plot + 
  ...
  coord_flip() + 
  labs(x = "Sample", y = "Fractional abundance")
...
taxonomic_level="order"
rpa_in_chart = .00001
prep_taxon_plot(file_path = file_path, map_path = map_path, plotvarnames = plotvarnames, mapper_file = mapper_file, taxonomic_level=taxonomic_level, rpa_in_chart = rpa_in_chart, read_depth = read_depth, legend_position=legend_position,  sort_x_axis = sort_x_axis,  x_cluster = x_cluster, predefined_taxa = predefined_taxa, predefined_shortname = predefined_shortname)[[3]] %>% filter(Var1 == "k__Bacteria_ p__Firmicutes_ c__Bacilli_ o__Lactobacillales") %>% dplyr::pull(perc)
...
plot_shapes <- points_data %>% filter(plot == "orchard") %>% arrange(desc(sortorder)) %>% pull(symbol) %>% rev()

flies2o2pcoa <- pcoa_manyvar_noellipse(folder_name="flies_mantel2o2/bray_curtis", mapper_file = "henrymapper2_JMC.txt", title_name_add=NULL, legend_position = "none", shape_var = "latitude", color_var = "latitude", fill_var = "latitude", circle_var = "latitude", linetype_var = "latitude", plot_shapes = plot_shapes, plot_fills = c(rep("black",10)), plot_colors = c(rep("black",10)), plot_ellipses = NULL, pco1 =1, pco2=2)
flies2o2pcoa
```
...
```{r}
#setwd('~/Dropbox/sequencing/2022-09-henry/')
plot_shapes <- points_data %>% filter(plot == "vineyard") %>% arrange(desc(sortorder)) %>% pull(symbol)
plot_shapes <- rev(c(15,14,14,10,3,7,1))

flies2v2pcoa <- pcoa_manyvar_noellipse(folder_name="flies_mantel2v2/bray_curtis", mapper_file = "henrymapper2_JMC.txt", title_name_add=NULL, legend_position = "none", shape_var = "latitude", color_var = "latitude", fill_var = "latitude", circle_var = "latitude", linetype_var = "latitude", plot_shapes = plot_shapes, plot_fills = c(rep("black",7)), plot_colors = c(rep("black",7)), plot_ellipses = NULL, pco1 =1, pco2=2)
flies2v2pcoa
```
...
mkdir core-metrics-results-east_coast_overall3/bray_curtis_pcoa_results
...
wget -O core-metrics-results-east_coast_overall3/bray_curtis_pcoa_results/ordination.txt https://raw.githubusercontent.com/johnchaston/Gale2024/refs/heads/main/core-metrics-results-east_coast_overall3/bray_curtis_pcoa_results/ordination.txt
...
### pcoa
```{r}
#setwd('~/Dropbox/sequencing/2022-08-ECrun1and2/')
plot_shapes <- points_data %>% filter(plot == "ec") %>% arrange(desc(sortorder)) %>% pull(symbol)

pcoaEC <- pcoa_manyvar_noellipse(folder_name="east_coast_overall3/bray_curtis", mapper_file = "mapper_1and2.tsv", title_name_add=NULL, legend_position = "none", shape_var = "latitude", color_var = "latitude", fill_var = "latitude", circle_var = "latitude", linetype_var = "latitude", plot_shapes = plot_shapes, plot_fills = c(rep("black",7)), plot_colors = c(rep("black",7)), pco1 =1, pco2=2)
pcoaEC
```
...
#mkdir core-metrics-results-utah_mantel500S/bray_curtis_pcoa_results
#wget -O core-metrics-results-utah_mantel500S/bray_curtis_pcoa_results/ordination.txt https://raw.githubusercontent.com/johnchaston/Gale2024/refs/heads/main/core-metrics-results-utah_mantel500S/bray_curtis_pcoa_results/ordination.txt
...
wget https://raw.githubusercontent.com/johnchaston/Gale2024/main/metadata_2018.txt
wget https://raw.githubusercontent.com/johnchaston/Gale2024/main/metadata_2009_to_12.txt
wget https://raw.githubusercontent.com/johnchaston/Gale2024/main/metadata_2021_JMC.txt
wget https://raw.githubusercontent.com/johnchaston/Gale2024/main/metadata_2020.txt
pwd
...
## henry
####
henryorchard3 <- mantel_EC18("henrymapper2_JMC.txt", "flies_mantel2o2", "metadata_2018.txt", cols_to_test = list(c("MaxTemp")),"bray_curtis") 
...
phenryorchard3 <- mantel_distance_plot(henryorchard3, y_title = "environmental distance", point_size = point_size) + labs(title = bquote(rho~" = 0.15, p = 0.003"))
...
henryorchard3_WU <- mantel_EC18("henrymapper2_JMC.txt", "flies_mantel2o2", "metadata_2018.txt", cols_to_test = list(c("MaxTemp")),"weighted_unifrac") 
...
phenryorchard3_WU <- mantel_distance_plot(henryorchard3, y_title = "environmental distance", point_size = point_size) + labs(title = bquote(rho~" = 0.20, p = 0.001"))
...
henryorchard3_UU <- mantel_EC18("henrymapper2_JMC.txt", "flies_mantel2o2", "metadata_2018.txt", cols_to_test = list(c("MaxTemp")),"unweighted_unifrac") 
...
phenryorchard3_UU <- mantel_distance_plot(henryorchard3, y_title = "environmental distance", point_size = point_size) + labs(title = bquote(rho~" = 0.11, p = 0.01"))
...
# sig sig not
henryv3 <- mantel_EC18("henrymapper2_JMC.txt", "flies_mantel2v2", "metadata_2018.txt", cols_to_test = list(c("MaxTemp")),"bray_curtis") 
henryvlat <- mantel_EC18("henrymapper2_JMC.txt", "flies_mantel2v2", "metadata_2018.txt", cols_to_test = list(c("latitude")),"bray_curtis") 
phenryv3 <- mantel_distance_plot(henryv3, y_title = "environmental distance", point_size = point_size)+ labs(title = bquote(rho~" = 0.10, p = 0.002"))
...
henryv3_WU <- mantel_EC18("henrymapper2_JMC.txt", "flies_mantel2v2", "metadata_2018.txt", cols_to_test = list(c("MaxTemp")),"weighted_unifrac") 
...
phenryv3_WU <- mantel_distance_plot(henryv3, y_title = "environmental distance", point_size = point_size)+ labs(title = bquote(rho~" = 0.09, p = 0.008"))
...
henryv3_UU <- mantel_EC18("henrymapper2_JMC.txt", "flies_mantel2v2", "metadata_2018.txt", cols_to_test = list(c("MaxTemp")),"unweighted_unifrac") 
...
phenryv3_UU <- mantel_distance_plot(henryv3, y_title = "environmental distance", point_size = point_size)+ labs(title = bquote(rho~" = 0.24, p = 0.001"))
...
## amber
####
amber3 <- mantel_EC18("Amber_mapper_9.txt", "redo2009m2", "metadata_2009_to_12.txt", cols_to_test = list(c("MaxTemp")),"bray_curtis") 
amberlat <- mantel_EC18("Amber_mapper_9.txt", "redo2009m2", "metadata_2009_to_12.txt", cols_to_test = list(c("latitude")),"bray_curtis") 
pamber3 <- mantel_distance_plot(amber3, y_title = "environmental distance", point_size = point_size)+ labs(title = bquote(rho~" = 0.15, p = 0.04"))
...
amber3_WU <- mantel_EC18("Amber_mapper_9.txt", "redo2009m2", "metadata_2009_to_12.txt", cols_to_test = list(c("MaxTemp")),"weighted_unifrac") 
...
pamber3_WU <- mantel_distance_plot(amber3, y_title = "environmental distance", point_size = point_size)+ labs(title = bquote(rho~" = 0.10, p = 0.11"))
...
amber3_UU <- mantel_EC18("Amber_mapper_9.txt", "redo2009m2", "metadata_2009_to_12.txt", cols_to_test = list(c("MaxTemp")),"unweighted_unifrac") 
...
pamber3_UU <- mantel_distance_plot(amber3, y_title = "environmental distance", point_size = point_size)+ labs(title = bquote(rho~" = 0.03, p = 0.33"))
...
####
## basically sig all
ec213 <- mantel_EC21seq("mapper_1and2.tsv","east_coast_overall3","metadata_2021_JMC.txt",list(c("MaxTemp")),"bray_curtis")
ec21lat <- mantel_EC21seq("mapper_1and2.tsv","east_coast_overall3","metadata_2021_JMC.txt",list(c("latitude")),"bray_curtis")
pec213 <- mantel_distance_plot(ec213, y_title = "environmental distance", point_size = point_size)+ labs(title = bquote(rho~" = 0.20, p = 0.001"))
...
ec213_WU <- mantel_EC21seq("mapper_1and2.tsv","east_coast_overall3","metadata_2021_JMC.txt",list(c("MaxTemp")),"weighted_unifrac")
ec21lat_WU <- mantel_EC21seq("mapper_1and2.tsv","east_coast_overall3","metadata_2021_JMC.txt",list(c("latitude")),"weighted_unifrac")
pec213_WU <- mantel_distance_plot(ec213, y_title = "environmental distance", point_size = point_size)+ labs(title = bquote(rho~" = 0.16, p = 0.003"))
...
ec213_UU <- mantel_EC21seq("mapper_1and2.tsv","east_coast_overall3","metadata_2021_JMC.txt",list(c("MaxTemp")),"unweighted_unifrac")
ec21lat_UU <- mantel_EC21seq("mapper_1and2.tsv","east_coast_overall3","metadata_2021_JMC.txt",list(c("latitude")),"unweighted_unifrac")
pec213_UU <- mantel_distance_plot(ec213, y_title = "environmental distance", point_size = point_size)+ labs(title = bquote(rho~" = 0.07, p = 0.10"))
...
## Utah
####
utah3 <- mantel_UT20("mapper_file_JMCv3_edit.tsv", "utah_mantel500S", "metadata_2020.txt", list(c("MaxTemp")), "bray_curtis")
...
putah3 <- mantel_distance_plot(utah3, y_title = "environmental distance", point_size = point_size)+ labs(title = bquote(rho~" = 0.17, p = 0.007"))
...
utah3_WU <- mantel_UT20("mapper_file_JMCv3_edit.tsv", "utah_mantel500S", "metadata_2020.txt", list(c("MaxTemp")), "weighted_unifrac")
...
putah3_WU <- mantel_distance_plot(utah3, y_title = "environmental distance", point_size = point_size)+ labs(title = bquote(rho~" = 0.09, p = 0.10"))
...
utah3_UU <- mantel_UT20("mapper_file_JMCv3_edit.tsv", "utah_mantel500S", "metadata_2020.txt", list(c("MaxTemp")), "unweighted_unifrac")
...
putah3_UU <- mantel_distance_plot(utah3, y_title = "environmental distance", point_size = point_size)+ labs(title = bquote(rho~" = 0.08, p = 0.12"))
...
### Fig S4 -  latitude vs temperature
```{r, warning=F, message=F}
...
bcd <- colnames(read.table("core-metrics-results-flies_mantel2o2/rarefied_table.txt", header = T, comment.char = "", sep = "\t", skip = 1))
abc <- read.table("henrymapper2_JMC.txt", fill = T, sep = "\t", comment.char = "", header = T)%>% filter(X.SampleID %in% bcd)
cde <- read.table("metadata_2018.txt", fill = T, sep = "\t", comment.char = "", header = T) %>% inner_join(abc, by = c("location"))%>% dplyr::select(MaxTemp,latitude) %>% dplyr::distinct()
cor.test(cde$MaxTemp, cde$latitude, method = "pearson")
orchardcorplot <- ggplot(cde, aes(x = latitude, y = MaxTemp)) + geom_point() + theme_cowplot() + labs(x = "Latitude (°N)", y = "Daily maximum temperature (°C)")

bcd <- colnames(read.table("core-metrics-results-flies_mantel2v2/rarefied_table.txt", header = T, comment.char = "", sep = "\t", skip = 1))
abc <- read.table("henrymapper2_JMC.txt", fill = T, sep = "\t", comment.char = "", header = T)%>% filter(X.SampleID %in% bcd)
cde <- read.table("metadata_2018.txt", fill = T, sep = "\t", comment.char = "", header = T) %>% inner_join(abc, by = c("location"))%>% dplyr::select(MaxTemp,latitude) %>% dplyr::distinct()
cor.test(cde$MaxTemp, cde$latitude, method = "pearson")
plot(cde$MaxTemp, cde$latitude)
vineyardcorplot <- ggplot(cde, aes(x = latitude, y = MaxTemp)) + geom_point() + theme_cowplot() + labs(x = "Latitude (°N)", y = "Daily maximum temperature (°C)")

bcd <- colnames(read.table("core-metrics-results-redo2009m2/rarefied_table.txt", header = T, comment.char = "", sep = "\t", skip = 1))
abc <- read.table("Amber_mapper_9.txt", fill = T, sep = "\t", comment.char = "", header = T)%>% filter(X.SampleID %in% gsub(pattern = "X", replacement = "", x = bcd))
cde <- read.table("metadata_2009_to_12.txt", fill = T, sep = "\t", comment.char = "", header = T) %>% inner_join(abc, by = c("location")) %>% dplyr::select(MaxTemp,latitude) %>% dplyr::distinct()
cor.test(cde$MaxTemp, cde$latitude, method = "pearson")
plot(cde$MaxTemp, cde$latitude)
ambercorplot <- ggplot(cde, aes(x = latitude, y = MaxTemp)) + geom_point() + theme_cowplot() + labs(x = "Latitude (°N)", y = "Daily maximum temperature (°C)")

bcd <- colnames(read.table("core-metrics-results-east_coast_overall3/rarefied_table.txt", header = T, comment.char = "", sep = "\t", skip = 1))
abc <- read.table("mapper_1and2.tsv", fill = T, sep = "\t", comment.char = "", header = T)%>% filter(X.SampleID %in% bcd)
cde <- read.table("metadata_2021_JMC.txt", fill = T, sep = "\t", comment.char = "", header = T) %>% inner_join(abc, by = c("location" = "site"))%>% dplyr::select(MaxTemp,latitude) %>% dplyr::distinct()
cor.test(cde$MaxTemp, cde$latitude, method = "pearson")
plot(cde$MaxTemp, cde$latitude)
eccorplot <- ggplot(cde, aes(x = latitude, y = MaxTemp)) + geom_point() + theme_cowplot() + labs(x = "Latitude (°N)", y = "Daily maximum temperature (°C)")

bcd <- colnames(read.table("core-metrics-results-utah_mantel500S/rarefied_table.txt", header = T, comment.char = "", sep = "\t", skip = 1))
abc <- read.table("mapper_file_JMCv3_edit.tsv", fill = T, sep = "\t", comment.char = "", header = T)%>% filter(X.SampleID %in% bcd)
cde <- read.table("metadata_2020.txt", fill = T, sep = "\t", comment.char = "", header = T) %>% inner_join(abc, by = c("location")) %>% mutate(latitude = ifelse(location == "Alpine, UT", 40.4457589, ifelse(location == "Logan, UT", 41.72573, ifelse(location == "Lindon1, UT", 40.3327707, ifelse(location == "Ogden, UT", 41.326252, ifelse(location == "Santaquin, UT", 39.966865, ifelse(location == "Lindon2, UT", 40.3327707,ifelse(location == "Lindon3, UT", 40.3327707,0)))))))) %>% dplyr::select(MaxTemp,latitude) %>% dplyr::distinct()
cor.test(cde$MaxTemp, cde$latitude, method = "pearson")
plot(cde$MaxTemp, cde$latitude)
utahcorplot <- ggplot(cde, aes(x = latitude, y = MaxTemp)) + geom_point() + theme_cowplot() + labs(x = "Latitude (°N)", y = "Daily maximum temperature (°C)")

#jpeg(h=3.7, w=12, "temp_and_latitude_correlations_pearson.jpg", units = "in", res=300)
grid.arrange(ambercorplot + labs(tag="A") + stat_smooth(method = "lm", alpha = 0)+ labs(title = "t = -0.27, p = 0.80"),
             vineyardcorplot + labs(tag="B") + stat_smooth(method = "lm", alpha = 0)+ labs(title = "t = -1.27, p = 0.26"),
             orchardcorplot + labs(tag="C") + stat_smooth(method = "lm", alpha = 0)+ labs(title = "t = -3.37, p < 0.01"),
             eccorplot + labs(tag="D") + stat_smooth(method = "lm", alpha = 0)+ labs(title = "t = -2.03, p = 0.10"),
             utahcorplot + labs(tag="E") + stat_smooth(method = "lm", alpha = 0) + labs(title = )+ labs(title = "t = -0.50, p = 0.64"),
             widths = c(1,1,1,1,1),
             heights = c(1),
             layout_matrix=rbind(		
                c(1,2,3,4,5)
...
p = "MaxRH" # AvgRH MinRH MaxRH
o = "MaxUVI" #AvgUVI MaxUVI


bcd <- colnames(read.table("core-metrics-results-flies_mantel2o2/rarefied_table.txt", header = T, comment.char = "", sep = "\t", skip = 1))
abc <- read.table("henrymapper2_JMC.txt", fill = T, sep = "\t", comment.char = "", header = T)%>% filter(X.SampleID %in% bcd)
cde <- read.table("metadata_2018.txt", fill = T, sep = "\t", comment.char = "", header = T) %>% inner_join(abc, by = c("location"))%>% dplyr::select(all_of(p), all_of(o)) %>% dplyr::distinct()
cor.test(cde[,p], cde[,o], method = "spearman")
orchardcorplot <- ggplot(cde, aes(x = get(p), y = get(o))) + geom_point() + theme_cowplot() + labs(x = "Daily max RH", y = "Daily max UVI")

bcd <- colnames(read.table("core-metrics-results-flies_mantel2v2/rarefied_table.txt", header = T, comment.char = "", sep = "\t", skip = 1))
abc <- read.table("henrymapper2_JMC.txt", fill = T, sep = "\t", comment.char = "", header = T)%>% filter(X.SampleID %in% bcd)
cde <- read.table("metadata_2018.txt", fill = T, sep = "\t", comment.char = "", header = T) %>% inner_join(abc, by = c("location"))%>% dplyr::select(all_of(p), all_of(o)) %>% dplyr::distinct()
cor.test(cde[,p], cde[,o], method = "spearman")
vineyardcorplot <- ggplot(cde, aes(x = get(p), y = get(o))) + geom_point() + theme_cowplot() + labs(x = "Daily max RH", y = "Daily max UVI")

bcd <- colnames(read.table("core-metrics-results-redo2009m2/rarefied_table.txt", header = T, comment.char = "", sep = "\t", skip = 1))
abc <- read.table("Amber_mapper_9.txt", fill = T, sep = "\t", comment.char = "", header = T)%>% filter(X.SampleID %in% gsub(pattern = "X", replacement = "", x = bcd))
cde <- read.table("metadata_2009_to_12.txt", fill = T, sep = "\t", comment.char = "", header = T) %>% inner_join(abc, by = c("location")) %>% dplyr::select(all_of(p), all_of(o)) %>% dplyr::distinct()
cor.test(cde[,p], cde[,o], method = "spearman")
ambercorplot <- ggplot(cde, aes(x = get(p), y = get(o))) + geom_point() + theme_cowplot() + labs(x = "Daily max RH", y = "Daily max UVI")

bcd <- colnames(read.table("core-metrics-results-east_coast_overall3/rarefied_table.txt", header = T, comment.char = "", sep = "\t", skip = 1))
abc <- read.table("mapper_1and2.tsv", fill = T, sep = "\t", comment.char = "", header = T)%>% filter(X.SampleID %in% bcd)
cde <- read.table("metadata_2021_JMC.txt", fill = T, sep = "\t", comment.char = "", header = T) %>% inner_join(abc, by = c("location" = "site"))%>% dplyr::select(all_of(p), all_of(o)) %>% dplyr::distinct()
cor.test(cde[,p], cde[,o], method = "spearman")
eccorplot <- ggplot(cde, aes(x = get(p), y = get(o))) + geom_point() + theme_cowplot() + labs(x = "Daily max RH", y = "Daily max UVI")

bcd <- colnames(read.table("core-metrics-results-utah_mantel500S/rarefied_table.txt", header = T, comment.char = "", sep = "\t", skip = 1))
abc <- read.table("mapper_file_JMCv3_edit.tsv", fill = T, sep = "\t", comment.char = "", header = T)%>% filter(X.SampleID %in% bcd)
cde <- read.table("metadata_2020.txt", fill = T, sep = "\t", comment.char = "", header = T) %>% inner_join(abc, by = c("location")) %>% mutate(latitude = ifelse(location == "Alpine, UT", 40.4457589, ifelse(location == "Logan, UT", 41.72573, ifelse(location == "Lindon1, UT", 40.3327707, ifelse(location == "Ogden, UT", 41.326252, ifelse(location == "Santaquin, UT", 39.966865, ifelse(location == "Lindon2, UT", 40.3327707,ifelse(location == "Lindon3, UT", 40.3327707,0)))))))) %>% dplyr::select(all_of(p), all_of(o)) %>% dplyr::distinct()
cor.test(cde[,p], cde[,o], method = "spearman")
utahcorplot <- ggplot(cde, aes(x = get(p), y = get(o))) + geom_point() + theme_cowplot() + labs(x = "Daily max RH", y = "Daily max UVI")


#jpeg(h=4, w=12, paste0(p,"_and_",o,"correlations.jpg"), units = "in", res=300)
grid.arrange(ambercorplot + labs(tag="F") + stat_smooth(method = "lm", alpha = 0)+ labs(title = "t = 1.48, p = 0.21"),
             vineyardcorplot + labs(tag="G") + stat_smooth(method = "lm", alpha = 0)+ labs(title = "No variation") + scale_x_continuous(breaks = 100, labels = 100, n.breaks = 1),
             orchardcorplot + labs(tag="H") + stat_smooth(method = "lm", alpha = 0)+ labs(title = "t = 2.32, p = 0.048"),
             eccorplot + labs(tag="I") + stat_smooth(method = "lm", alpha = 0)+ labs(title = "t = -0.11, p = 0.92"),
             utahcorplot + labs(tag="J") + stat_smooth(method = "lm", alpha = 0) + labs(title = )+ labs(title = "t = 0.04, p = 0.97"),
             widths = c(1,1,1,1,1),
             heights = c(1),
             layout_matrix=rbind(		
                c(1,2,3,4,5)
...
```{sh, eval=F}
pwd
mkdir core-metrics-results-desteuropea
mkdir core-metrics-results-desteuropea/bray_curtis_distance_matrix
wget -O core-metrics-results-desteuropea/rarefied_table.txt https://raw.githubusercontent.com/johnchaston/Gale2024/main/core-metrics-results-desteuropea/rarefied_table.txt
wget -O core-metrics-results-desteuropea/bray_curtis_distance_matrix/distance-matrix.tsv https://raw.githubusercontent.com/johnchaston/Gale2024/main/core-metrics-results-desteuropea/bray_curtis_distance_matrix/distance-matrix.tsv
mkdir core-metrics-results-destusa
mkdir core-metrics-results-destusa/bray_curtis_distance_matrix
wget -O core-metrics-results-destusa/rarefied_table.txt https://raw.githubusercontent.com/johnchaston/Gale2024/main/core-metrics-results-destusa/rarefied_table.txt
wget -O core-metrics-results-destusa/bray_curtis_distance_matrix/distance-matrix.tsv https://raw.githubusercontent.com/johnchaston/Gale2024/main/core-metrics-results-destusa/bray_curtis_distance_matrix/distance-matrix.tsv
wget -O DESTEuropeMetadata.txt https://raw.githubusercontent.com/johnchaston/Gale2024/main/DESTEuropeMetadata.txt
wget -O DESTUsaMetadata.txt https://raw.githubusercontent.com/johnchaston/Gale2024/main/DESTUsaMetadata.txt
wget -O DESTUsaMetadata.txt https://raw.githubusercontent.com/johnchaston/Gale2024/main/DESTUsaMetadata.txt
wget -O DESTmapper_v3.txt https://raw.githubusercontent.com/johnchaston/Gale2024/main/DESTmapper_v3.txt
wget -O DESTmapper_v3b.txt https://raw.githubusercontent.com/johnchaston/Gale2024/main/DESTmapper_v3b.txt
mkdir taxonomy-DEST
wget -O taxonomy-DEST/taxonomy_forR.csv https://raw.githubusercontent.com/johnchaston/Gale2024/main/taxonomy-DEST/taxonomy_forR.csv


mkdir core-metrics-results-destusa/bray_curtis_pcoa_results
wget -O core-metrics-results-destusa/bray_curtis_pcoa_results/ordination.txt https://raw.githubusercontent.com/johnchaston/Gale2024/main/core-metrics-results-destusa/bray_curtis_pcoa_results/ordination.txt
mkdir core-metrics-results-desteuropea/bray_curtis_pcoa_results
wget -O core-metrics-results-desteuropea/bray_curtis_pcoa_results/ordination.txt https://raw.githubusercontent.com/johnchaston/Gale2024/main/core-metrics-results-desteuropea/bray_curtis_pcoa_results/ordination.txt

```

### Europe and USA Mantel tests
```{r, warning=F, message=F}
## test each individual (table S3)

# j= "desteuropea"; mapper_file = "DESTEuropeMetadata.txt"
# for (i in c("Latitude","CollectionDate","MaxTemp","MinTemp","AvgTemp","MaxcDHI","AvgcDHI","MaxcDNI","AvgcDNI","MaxcGHI","AvgcGHI","MaxDP","MinDP","AvgDP","MaxDHI","AvgDHI","MaxFF","AvgFF","MaxRH","MinRH","AvgRH","MaxSZA","MinSZA","AvgSZA","MaxSA","MinSA","AvgSA","MaxPress","MinPress","AvgPres","MaxPW","MinPW","AvgPW","MaxWD","MinWD","AvgWD","MaxWS","MinWS","AvgWS","MaxUVO","AvgUVO","MaxUVI","AvgUVI")) {
#     DESTmantel <- calc_mantel_microbiome(j,"bray_curtis",mapper_file,c(i), filter = T)
# }
# 
# j= "destusa"; mapper_file = "DESTUsaMetadata.txt"
# for (i in c("Latitude","CollectionDate","MaxTemp","MinTemp","AvgTemp","MaxcDHI","AvgcDHI","MaxcDNI","AvgcDNI","MaxcGHI","AvgcGHI","MaxDP","MinDP","AvgDP","MaxDHI","AvgDHI","MaxFF","AvgFF","MaxRH","MinRH","AvgRH","MaxSZA","MinSZA","AvgSZA","MaxSA","MinSA","AvgSA","MaxPress","MinPress","AvgPres","MaxPW","MinPW","AvgPW","MaxWD","MinWD","AvgWD","MaxWS","MinWS","AvgWS","MaxUVO","AvgUVO","MaxUVI","AvgUVI")) {
#     DESTmantel <- calc_mantel_microbiome(j,"bray_curtis",mapper_file,c(i), filter = F)
# }

## make figures based on Temperature and Latitude
usalat <- calc_mantel_microbiome("destusa","bray_curtis","DESTUsaMetadata.txt",c("Latitude"))
usatemp <- calc_mantel_microbiome("destusa","bray_curtis","DESTUsaMetadata.txt",c("MaxTemp"))
usalatplot <- mantel_distance_plot(usalat, y_title = "Microbiota distance", x_title = "Env. distance\n(latitude (°)", point_size = 0.1) + labs(title = bquote(rho~" = 0.01, p = 0.39"))
usatempplot <- mantel_distance_plot(usatemp, y_title = "Microbiota distance", x_title = "Env. distance\n(temperature (°C))", point_size = 0.1) + labs(title = bquote(rho~" = 0.11, p = 0.02"))

europelat <- calc_mantel_microbiome("desteuropea","bray_curtis","DESTEuropeMetadata.txt",c("Latitude"), filter = T)
europetemp <- calc_mantel_microbiome("desteuropea","bray_curtis","DESTEuropeMetadata.txt",c("MaxTemp"), filter = T)
europelatplot <- mantel_distance_plot(europelat, y_title = "Microbiota distance", x_title = "Env. distance\n(latitude (°)", point_size = 0.1) + labs(title = bquote(rho~" = 0.16, p = 0.001"))
europetempplot <- mantel_distance_plot(europetemp, y_title = "Microbiota distance", x_title = "Env. distance\n(temperature (°C))", point_size = 0.1) + labs(title = bquote(rho~" = 0.13, p = 0.004"))
```

## europe and usa map
```{r, warning=F, message=F}
mapper3b <- readr::read_tsv(file = "https://raw.githubusercontent.com/johnchaston/Gale2024/main/DESTmapper_v3b.txt", show_col_types = F, comment = "") %>% dplyr::rename(X.SampleID=`#SampleID`)

map2 <- map_data("world")
map2sub <- map2 %>% filter(region %in% c(mapper3b$Country,"UK"), !region %in% c("USA","Canada", "Guadeloupe"))
map2sub$group2 <- map2sub$group
map2sub$color <- "white"

europemap <- ggplot() + 
  geom_polygon(data=map2sub %>% filter(lat < 70, long <45) %>% droplevels(), aes(x=long, y=lat, group=group2), color="grey",fill="white") + 
  coord_fixed(1.3) + 
  theme_void() +
  geom_point(data = mapper3b %>% filter(!Country%in% c("USA","Canada", "Guadeloupe")) %>% filter(X.SampleID %in% colnames(readr::read_tsv('https://raw.githubusercontent.com/johnchaston/Gale2024/refs/heads/main/core-metrics-results-desteuropea/rarefied_table.txt', show_col_types = F, skip = 1))[-1]), aes(y=Latitude, x=Longitude), size = 2.5, color = "black") 

map2sub <- map2 %>% filter(region %in% c("USA","Canada"))
map2sub$group2 <- map2sub$group
map2sub$color <- "white"

usamap <- ggplot() + 
  geom_polygon(data=map2sub %>% filter(lat < 50, long > -130) %>% droplevels(), aes(x=long, y=lat, group=group2), color="grey",fill="white") + 
  coord_fixed(1.3) + 
  theme_void() +
  geom_point(data = mapper3b %>% filter(Country%in% c("USA","Canada")) %>% filter(X.SampleID %in% colnames(readr::read_tsv('https://raw.githubusercontent.com/johnchaston/Gale2024/refs/heads/main/core-metrics-results-destusa/rarefied_table.txt', show_col_types = F, skip = 1))[-1]), aes(y=Latitude, x=Longitude), size = 2.5, color = "black") 
usamap
...
file_path = "desteuropea"
map_path = "-DEST" # taxonomy folder extension
plotvarnames = c("LocalityID", "Country") 
mapper_file = "DESTmapper_v3.txt" 
taxonomic_level="genus"
rpa_in_chart = .02
read_depth = 500
legend_position = "bottom"
...
x_cluster <- "LocalityID"
plot_color <- c("black","green1","blue","yellow","orange","magenta","red")
plot_order <- c("Gammaproteobacteriaunclassified","Lactobacillus","Commensalibacter","Gluconobacter","Komagataeibacter","Acetobacter")
facet_formula <- ". ~ Country"
sort_x_axis <- "LocalityID"
legend_position = "bottom"

base_plot <- make_taxon_plot_condensed(ptp = ptp, plot_color = plot_color, facet_formula = facet_formula, sort_x_axis = sort_x_axis, x_cluster = x_cluster, plotvarnames = plotvarnames, legend_position = legend_position, read_depth = read_depth, plot_order = plot_order, xorder = "LocalityID")
europe_plot <- base_plot + 
  facet_grid(cols = vars(Country), drop = FALSE, as.table = FALSE, scales = "free", space = "free") +
  theme(strip.text.x = element_text(angle = 90, hjust=0), axis.text.x = element_blank(), strip.text.y = element_text(angle = 0), strip.background.x = element_rect(fill = "white"), legend.position = "none", axis.title = element_text(face = "bold")) + 
  labs(x = "Location") 
europe_plot
...
file_path <- "destusa"
map_path = "-DEST" # taxonomy folder extension
plotvarnames = c("State","LocalityID") 
mapper_file = "DESTmapper_v3b.txt"
taxonomic_level="genus"
rpa_in_chart = .02
read_depth = 500
legend_position = "bottom"
...
x_cluster <- "LocalityID"
plot_color <- c("black","black","green1","green1","purple1","blue","yellow","orange","magenta","red")
plot_order <- c("Saccharomyces","Providencia","Gammaproteobacteriaunclassified","Leuconostoc","Lactobacillus","Commensalibacter","Gluconobacter","Komagataeibacter","Acetobacter")
facet_formula <- ". ~ State"
sort_x_axis <- "LocalityID"
legend_position = "bottom"
...
base_plot <- make_taxon_plot_condensed(ptp = ptp, plot_color = plot_color, facet_formula = facet_formula, sort_x_axis = sort_x_axis, x_cluster = x_cluster, plotvarnames = plotvarnames, legend_position = legend_position, read_depth = read_depth, plot_order = plot_order, xorder = "LocalityID")
usa_plot <- base_plot + 
  facet_grid(cols = vars(State), drop = FALSE, as.table = FALSE, scales = "free", space = "free") +
  theme(strip.text.x = element_text(angle = 90, hjust=0), axis.text.x = element_blank(), strip.text.y = element_text(angle = 0), strip.background.x = element_rect(fill = "white"), legend.position = "none", axis.title = element_text(face = "bold")) + 
  labs(x = "Location") 
usa_plot
...
for(i in c("MaxTemp","MinTemp","AvgTemp","MaxcDHI","AvgcDHI","MaxcDNI","AvgcDNI","MaxcGHI","AvgcGHI","MaxDP","MinDP","AvgDP","MaxDHI","AvgDHI","MaxFF","AvgFF","MaxRH","MinRH","AvgRH","MaxSZA","MinSZA","AvgSZA","MaxSA","MinSA","AvgSA","MaxPress","MinPress","AvgPres","MaxPW","MinPW","AvgPW","MaxWD","MinWD","AvgWD","MaxWS","MinWS","AvgWS","MaxUVO","AvgUVO","MaxUVI","AvgUVI")) {
  mantel_EC18("henrymapper2_JMC.txt", "flies_mantel2o2", "metadata_2018.txt", cols_to_test = i,"bray_curtis") 
}

for(i in c("MaxTemp","MinTemp","AvgTemp","MaxcDHI","AvgcDHI","MaxcDNI","AvgcDNI","MaxcGHI","AvgcGHI","MaxDP","MinDP","AvgDP","MaxDHI","AvgDHI","MaxFF","AvgFF","MaxRH","MinRH","AvgRH","MaxSZA","MinSZA","AvgSZA","MaxSA","MinSA","AvgSA","MaxPress","MinPress","AvgPres","MaxPW","MinPW","AvgPW","MaxWD","MinWD","AvgWD","MaxWS","MinWS","AvgWS","MaxUVO","AvgUVO","MaxUVI","AvgUVI")) {
  mantel_EC18("henrymapper2_JMC.txt", "flies_mantel2v2", "metadata_2018.txt", cols_to_test = i,"bray_curtis") 
}

for(i in c("MaxTemp","MinTemp","AvgTemp","MaxcDHI","AvgcDHI","MaxcDNI","AvgcDNI","MaxcGHI","AvgcGHI","MaxDP","MinDP","AvgDP","MaxDHI","AvgDHI","MaxFF","AvgFF","MaxRH","MinRH","AvgRH","MaxSZA","MinSZA","AvgSZA","MaxSA","MinSA","AvgSA","MaxPress","MinPress","AvgPres","MaxPW","MinPW","AvgPW","MaxWD","MinWD","AvgWD","MaxWS","MinWS","AvgWS","MaxUVO","AvgUVO","MaxUVI","AvgUVI")) {
  mantel_EC18("Amber_mapper_9.txt", "redo2009m2", "metadata_2009_to_12.txt", cols_to_test = i,"bray_curtis") 
}

for(i in c("MaxTemp","MinTemp","AvgTemp","MaxcDHI","AvgcDHI","MaxcDNI","AvgcDNI","MaxcGHI","AvgcGHI","MaxDP","MinDP","AvgDP","MaxDHI","AvgDHI","MaxFF","AvgFF","MaxRH","MinRH","AvgRH","MaxSZA","MinSZA","AvgSZA","MaxSA","MinSA","AvgSA","MaxPress","MinPress","AvgPres","MaxPW","MinPW","AvgPW","MaxWD","MinWD","AvgWD","MaxWS","MinWS","AvgWS","MaxUVO","AvgUVO","MaxUVI","AvgUVI")) {
  mantel_EC21seq("mapper_1and2.tsv","east_coast_overall3","metadata_2021_JMC.txt", cols_to_test = i,"bray_curtis") 
}

for(i in c("MaxTemp","MinTemp","AvgTemp","MaxcDHI","AvgcDHI","MaxcDNI","AvgcDNI","MaxcGHI","AvgcGHI","MaxDP","MinDP","AvgDP","MaxDHI","AvgDHI","MaxFF","AvgFF","MaxRH","MinRH","AvgRH","MaxSZA","MinSZA","AvgSZA","MaxSA","MinSA","AvgSA","MaxPress","MinPress","AvgPres","MaxPW","MinPW","AvgPW","MaxWD","MinWD","AvgWD","MaxWS","MinWS","AvgWS","MaxUVO","AvgUVO","MaxUVI","AvgUVI")) {
  mantel_UT20("mapper_file_JMCv3_edit.tsv", "utah_mantel500S", "metadata_2020.txt", cols_to_test = i,"bray_curtis") 
}
...
i=1.3
jpeg(h=12*i, w=6*i*2, "photoperiod_figureSephi.jpg", units = "in", res=300)
grid.arrange(photoplot_A_M + labs(tag="C"),
             photoplot_A_F + labs(tag="D"),
             photoplot_B_M + labs(tag="E"),
             photoplot_B_F + labs(tag="F"),
             photoplot_C_M + labs(tag="G"),
             photoplot_C_F + labs(tag="H"),
             photoplotabun_A_M + labs(tag="I"),
             photoplotabun_A_F + labs(tag="J"),
             photoplotabun_B_M + labs(tag="K"),
             photoplotabun_B_F + labs(tag="L"),
             photoplotabun_C_M + labs(tag="M"),
             photoplotabun_C_F + labs(tag="N"),
             photoperiod_relative + labs(tag="A"),
             photoperiod_abundance + labs(tag="B"),
             widths = c(1,1,1,1),
             heights = c(1,1,1,1),
             layout_matrix=rbind(		
                c(13,14,NA,NA),
...
plot_legend_ec <- g_legend(ec2021 + theme(legend.position = "bottom", legend.text = element_text(size = 12)) + guides(fill=guide_legend(ncol=5,byrow=F)) + scale_fill_manual(name = "           ", values = c("black",predefined_colors[-c(1,2,4,12)]), labels = c("other", bquote(italic(Pasteurellales)), bquote(italic(Enterobacteriaceae)),bquote(italic(Lactobacillales)), bquote(italic(Lactobacillaceae)), bquote(italic(Enterococcus)), bquote(italic(Leuconostoc)), bquote(italic(Weissella)), bquote(italic(Lactobacillus)), bquote(italic(Acetobacteraceae)), bquote(italic(Commensalibacter)), bquote(italic(Gluconobacter)), bquote(italic(Komagataeibacter)), bquote(italic(Acetobacter)))))
...
#jpeg(h=20, w=16, "~/Dropbox/east_coast_flies_manuscript/Figure1_oct2024.jpg", units = "in", res=300)
grid.arrange(ecmap + labs(tag = "A") + theme(plot.tag = element_text(face = "bold", size = fig1tagsize)), 
             ...
             pamber3+ theme(text = element_text(size=mantel_size*1.15), axis.text = element_text(size=mantel_size)) + labs(x = "Env. distance\n (temperature (°C))", y = "Microbiota distance", tag = "J") + theme(plot.tag = element_text(face = "bold", size = fig1tagsize), plot.title = element_text(color = "blue", size = mantel_size * 1.15)),
             ...
             phenryv3+ theme(text = element_text(size=mantel_size*1.15), axis.text = element_text(size=mantel_size)) + labs(x = "Env. distance\n (temperature (°C))", y = "Microbiota distance", tag = "K")+ theme(plot.tag = element_text(face = "bold", size = fig1tagsize), plot.title = element_text(color = "blue", size = mantel_size * 1.15)),
             ...
             phenryorchard3+ theme(text = element_text(size=mantel_size*1.15), axis.text = element_text(size=mantel_size)) + labs(x = "Env. distance\n (temperature (°C))", y = "Microbiota distance", tag = "L")+ theme(plot.tag = element_text(face = "bold", size = fig1tagsize), plot.title = element_text(color = "blue", size = mantel_size * 1.15)),
             ...
             pec213+ theme(text = element_text(size=mantel_size*1.15), axis.text = element_text(size=mantel_size)) + labs(x = "Env. distance\n (temperature (°C))", y = "Microbiota distance", tag = "M")+ theme(plot.tag = element_text(face = "bold", size = fig1tagsize), plot.title = element_text(color = "blue", size = mantel_size * 1.15)),
             plot_legend_ec,
             temp_relative + labs(tag="V") + theme(plot.tag = element_text(face = "bold", size = fig1tagsize)),
             temp_absolute + labs(tag="W") + theme(plot.tag = element_text(face = "bold", size = fig1tagsize)),
             usa_plot + labs(tag="P") + theme(plot.tag = element_text(face = "bold", size = fig1tagsize)) + theme(strip.text.x = element_text(size = 8)),
             europe_plot+ labs(tag="Q") + theme(plot.tag = element_text(face = "bold", size = fig1tagsize)) + theme(strip.text.x = element_text(size = 8)),
            usamap+ labs(tag="N") + theme(plot.tag = element_text(face = "bold", size = fig1tagsize)),
            europemap+ labs(tag="O") + theme(plot.tag = element_text(face = "bold", size = fig1tagsize)),
             usalatplot+ labs(tag="R") + theme(plot.tag = element_text(face = "bold", size = fig1tagsize)),
             usatempplot + theme(plot.title = element_text(color = "blue"))+ labs(tag="S") + theme(plot.tag = element_text(face = "bold", size = fig1tagsize)),
             europelatplot + theme(plot.title = element_text(color = "blue"))+ labs(tag="T") + theme(plot.tag = element_text(face = "bold", size = fig1tagsize)),
             europetempplot + theme(plot.title = element_text(color = "blue"))+ labs(tag="U") + theme(plot.tag = element_text(face = "bold", size = fig1tagsize)),
            layout_matrix=rbind(		
                c(1, 1, 1, 1, 2, 3, 3, 4, 5, 5, 6, 7, 7, 8, 9),
#                c(1,1,1,18,18,18,18,18,18,18,18,18),
                c(1, 1, 1, 1, 10,10,10,12,12,12,14,14,14,16,16),
                c(18,18,18,18,10,10,10,12,12,12,14,14,14,16,16),
                c(18,18,18,18,11,11,11,13,13,13,15,15,15,17,17),
                c(23,23,23,23,23,23,24,24,24,24,24,24,19,19,19),
                c(21,21,21,21,22,22,22,22,22,22,22,22,19,19,19),
                c(21,21,21,21,22,22,22,22,22,22,22,22,20,20,20),
                c(25,25,26,26,26,26,27,27,27,28,28,28,20,20,20)
             ),
             widths = c(.2765,.07355,.11265,.09,.07,.077,.173,.07,.11,.14,.09,.1225,.25-.1225,.07,.25),
             heights = c(2,.65,.65,1.3,2,.65,1.35,1.3)
)
#dev.off()
```
...
#jpeg(h=4, w=16, "~/Dropbox/east_coast_flies_manuscript/FigureSXpcoa_may2025.jpg", units = "in", res=300)
grid.arrange(ecmap2 + labs(tag = "A") + theme(plot.tag = element_text(face = "bold", size = fig1tagsize)), 
             amber_pcoa_plot + theme(legend.position = "none", strip.text = element_blank(), panel.spacing = unit(-.1, "lines"), axis.text.x = element_text(size =12, angle = 90)) + labs(tag = "B", title = NULL) + theme(plot.tag = element_text(face = "bold", size = fig1tagsize)),
             flies2v2pcoa + theme(legend.position = "none", strip.text = element_blank(), panel.spacing = unit(-.1, "lines"), axis.text.x = element_text(size =12, angle = 90), axis.title.y = element_blank()) + labs(tag = "C") + theme(plot.tag = element_text(face = "bold", size = fig1tagsize)),
             flies2o2pcoa + theme(legend.position = "none", strip.text = element_blank(), panel.spacing = unit(-.1, "lines"), axis.text.x = element_text(size =12, angle = 90), axis.title.y = element_blank()) + labs(tag = "D") + theme(plot.tag = element_text(face = "bold", size = fig1tagsize)),
             pcoaEC+ theme(legend.position = "none", strip.text = element_blank(), panel.spacing = unit(-.1, "lines"), axis.text.x = element_text(size =12, angle = 90)) + labs(tag = "E") + theme(plot.tag = element_text(face = "bold", size = fig1tagsize)),
...
## Figure S3 - UU and WU mantel results
```{r, warning=F, message=F}
#jpeg(h=8*.875*1.5, w=28*.875*.75, "~/Dropbox/east_coast_flies_manuscript/Figure1_sep2024c_supp.jpg", units = "in", res=300)
grid.arrange(pamberlat_WU + theme(text = element_text(size=mantel_size*1.15), axis.text = element_text(size=mantel_size)) + labs(x = "Env. distance\n (latitude (°))", y = "Microbiota distance", tag = "A")+ theme(plot.tag = element_text(face = "bold", size = fig1tagsize), plot.title = element_text(color = "blue", size = mantel_size * 1.15)),   
             pamber3_WU+ theme(text = element_text(size=mantel_size*1.15), axis.text = element_text(size=mantel_size)) + labs(x = "Env. distance\n (temperature (°C))", y = "Microbiota distance", tag = "E")+ theme(plot.tag = element_text(face = "bold", size = fig1tagsize), plot.title = element_text(color = "black", size = mantel_size * 1.15)),
             ...
             phenryv3_WU+ theme(text = element_text(size=mantel_size*1.15), axis.text = element_text(size=mantel_size)) + labs(x = "Env. distance\n (temperature (°C))", y = "Microbiota distance", tag = "F")+ theme(plot.tag = element_text(face = "bold", size = fig1tagsize), plot.title = element_text(color = "blue", size = mantel_size * 1.15)),
             ...
             phenryorchard3_WU+ theme(text = element_text(size=mantel_size*1.15), axis.text = element_text(size=mantel_size)) + labs(x = "Env. distance\n (temperature (°C))", y = "Microbiota distance", tag = "G")+ theme(plot.tag = element_text(face = "bold", size = fig1tagsize), plot.title = element_text(color = "blue", size = mantel_size * 1.15)),
             ...
             pec213_WU+ theme(text = element_text(size=mantel_size*1.15), axis.text = element_text(size=mantel_size)) + labs(x = "Env. distance\n (temperature (°C))", y = "Microbiota distance", tag = "H")+ theme(plot.tag = element_text(face = "bold", size = fig1tagsize), plot.title = element_text(color = "blue", size = mantel_size * 1.15)),
             ...
             pamber3_UU+ theme(text = element_text(size=mantel_size*1.15), axis.text = element_text(size=mantel_size)) + labs(x = "Env. distance\n (temperature (°C))", y = "Microbiota distance", tag = "M")+ theme(plot.tag = element_text(face = "bold", size = fig1tagsize), plot.title = element_text(color = "black", size = mantel_size * 1.15)),
             ...
             phenryv3_UU+ theme(text = element_text(size=mantel_size*1.15), axis.text = element_text(size=mantel_size)) + labs(x = "Env. distance\n (temperature (°C))", y = "Microbiota distance", tag = "N")+ theme(plot.tag = element_text(face = "bold", size = fig1tagsize), plot.title = element_text(color = "blue", size = mantel_size * 1.15)),
             ...
             phenryorchard3_UU+ theme(text = element_text(size=mantel_size*1.15), axis.text = element_text(size=mantel_size)) + labs(x = "Env. distance\n (temperature (°C))", y = "Microbiota distance", tag = "O")+ theme(plot.tag = element_text(face = "bold", size = fig1tagsize), plot.title = element_text(color = "blue", size = mantel_size * 1.15)),
             ...
             pec213_UU+ theme(text = element_text(size=mantel_size*1.15), axis.text = element_text(size=mantel_size)) + labs(x = "Env. distance\n (temperature (°C))", y = "Microbiota distance", tag = "P")+ theme(plot.tag = element_text(face = "bold", size = fig1tagsize), plot.title = element_text(color = "black", size = mantel_size * 1.15)),
            layout_matrix=rbind(
              c(1,3,5,7),
              c(2,4,6,8),
              c(9,11,13,15),
...
## Figure S1 - Utah flies figure
```{r, warning=F, message=F}
plot_ut_legend <- g_legend(ut2020 + theme(legend.position = "bottom", legend.text = element_text(size = 12), legend.title = element_blank()) + guides(fill=guide_legend(ncol=5,byrow=TRUE)))
plot(plot_ut_legend)
utpoints <- ggplot(points_data %>% filter(plot=="utah"), aes(x = column, y = row, shape = symbol)) +   geom_point(size = 2) + scale_shape_identity() +   theme_cowplot() + theme(legend.position = "none")+   xlim(c(0.88,1.12)) + ylim(c(3.8,8.3))
 ...
 #  jpeg(h=9, w=9, "~/Dropbox/east_coast_flies_manuscript/FigureSX_utah_sep2024.jpg", units = "in", res=300)
   grid.arrange(utmap + labs(tag = "A")+ theme(plot.tag = element_text(face = "bold", size = fig1tagsize)),
                ...
                putah3+ theme(text = element_text(size=mantel_size*1.15), axis.text = element_text(size=mantel_size)) + labs(x = "Env. distance\n (temperature (°C))", y = "microbiota distance", tag = "D")+ theme(plot.tag = element_text(face = "bold", size = fig1tagsize), plot.title = element_text(color = "blue", size = mantel_size * 1.15)),
...
mkdir core-metrics-results-4wayTaxon/bray_curtis_pcoa_results
wget -O core-metrics-results-4wayTaxon/bray_curtis_pcoa_results/ordination.txt https://raw.githubusercontent.com/johnchaston/Gale2024/main/core-metrics-results-4wayTaxon/bray_curtis_pcoa_results/ordination.txt
mkdir core-metrics-results-4wayTaxon/weighted_unifrac_pcoa_results
wget -O core-metrics-results-4wayTaxon/weighted_unifrac_pcoa_results/ordination.txt https://raw.githubusercontent.com/johnchaston/Gale2024/main/core-metrics-results-4wayTaxon/weighted_unifrac_pcoa_results/ordination.txt
mkdir core-metrics-results-4wayTaxon/unweighted_unifrac_pcoa_results
wget -O core-metrics-results-4wayTaxon/unweighted_unifrac_pcoa_results/ordination.txt https://raw.githubusercontent.com/johnchaston/Gale2024/main/core-metrics-results-4wayTaxon/unweighted_unifrac_pcoa_results/ordination.txt
pwd
```
...
color_var = "plotorder"
fill_var = "plotorder"
circle_var = "plotorder"
linetype_var = "plotorder"
plot_shapes <- c(21,21,21,21)
plot_fills <- c("cyan","orange","black","magenta","red","orange")
plot_colors <- c("cyan","orange","black","magenta","red","orange")
plot_ellipses <- c("solid","solid","solid","solid","solid","solid")
i="weighted_unifrac"
for (i in c("unweighted_unifrac","weighted_unifrac","bray_curtis")) {
  if (i == "unweighted_unifrac") {title_name_add <- "Unweighted Unifrac"
  } else if (i == "weighted_unifrac") {title_name_add <- "Weighted Unifrac"
  ...
  legend_position = "none"
  folder_name = paste0(file_path,"/",i)
  assign(paste0("pcoag_cornstageonly_",i), pcoa_manyvar_solidlineplot(folder_name=folder_name, mapper_file = mapper_file, title_name_add=title_name_add, legend_position = legend_position, shape_var = shape_var, color_var = color_var, fill_var = fill_var, circle_var = circle_var, linetype_var = linetype_var, plot_shapes = plot_shapes, plot_fills = plot_fills, plot_colors = plot_colors, plot_ellipses = plot_ellipses, pco1 =1, pco2=2, circle_color = plot_colors))
}

pcoag_cornstageonly_unweighted_unifrac
pcoag_cornstageonly_weighted_unifrac + theme(legend.position = "bottom")
bc_fig2_plot <- pcoag_cornstageonly_bray_curtis + theme(legend.position = "bottom")
bc_fig2_plot

# jpeg(h=600*i, w=1600*i, "Figure1_MF_nov2023.jpg", units = "px", quality = 0.9, pointsize = 1/300)
# 	grid.arrange(	
...
axis.text.x = element_blank()
  ...
  ggplot2::annotate("segment",x=Inf,xend=-Inf,y=Inf,yend=Inf,color="black",lwd=1) +
  labs(x = NULL)  +
    geom_text(data = melt_table_plot, aes(y = 1.1, label = Letter))
...
for i in pile_flies; do
 ...
 wget -O core-metrics-results-$i/rarefied_table.txt https://raw.githubusercontent.com/johnchaston/Gale2024/main/core-metrics-results-$i/rarefied_table.txt
  ...
  for j in unweighted_unifrac_pcoa_results weighted_unifrac_pcoa_results bray_curtis_pcoa_results ; do
  mkdir core-metrics-results-$i""/$j
  wget -O core-metrics-results-$i""/$j/ordination.txt https://raw.githubusercontent.com/johnchaston/Gale2024/main/core-metrics-results-$i""/$j/ordination.txt
  done;
done
pwd
```
...
plotvarnames = c("plotorder","orchard_subsite","site","ospo") 
  ## plot by cornstage only
shape_var = "fps_location"
color_var = "fp_subsite"
fill_var = "fp_subsite"
circle_var = "fp_subsite"
linetype_var = "fp_subsite"
plot_shapes <- c(15,16,17,0,1,2)
plot_fills <- c("cyan","black","magenta","red","orange")
plot_colors <- c("cyan","black","magenta","red","orange")
plot_ellipses <- c("solid","solid","solid","solid","solid","solid")
i="weighted_unifrac"
for (i in c("unweighted_unifrac","weighted_unifrac","bray_curtis")) {
  if (i == "unweighted_unifrac") {title_name_add <- "Unweighted Unifrac"
...
pcoag_cornstageonly_unweighted_unifrac
pcoag_cornstageonly_weighted_unifrac + theme(legend.position = "bottom")
bc_pile_flies <- pcoag_cornstageonly_bray_curtis + theme(legend.position = "bottom")
bc_pile_flies
...
#jpeg(h=3*i, w=9*i, "figure_sufs_apr2025.jpg", units = "in", res=300)
grid.arrange(bc_fig2_plot + theme(legend.position = "none", axis.title =element_text(face = "bold", size = smallsize)) + labs(title = NULL),
             ggplot() + theme_void(),
             neutral_plot,
             bc_pile_flies  + theme(legend.position = "none", axis.title =element_text(face = "bold", size = smallsize)) + labs(title = NULL),
             pile_c + labs(tag = "E") + theme(axis.title.x = element_blank(), axis.text.x = element_blank(), plot.tag = element_text(face = "bold", size = tagsize), axis.title.y = element_text(size = smallsize)),
             pile_d + labs(tag = "F", x= "Site sampled") + theme(plot.tag = element_text(face = "bold", size = tagsize), axis.title.y = element_text(size = smallsize)),
             widths = c(2,2,2,1),
             heights = c(1,1),
             layout_matrix=rbind(		
                c(1,2,4,5),
...
grid.text(c("Comparison","Reference"), x = unit(c(.32,.32), "npc"), y = unit(c(.38, .45), "npc"), hjust = 1, vjust = 0.5,gp=gpar(fontsize=12)) 
grid.text(c(expression(bold("A")),expression(bold("B")),expression(bold("C")),expression(bold("D"))), x = unit(c(0.014, 0.31, .31, .58), "npc"), y = unit(c(.965,.965,.5,.965), "npc"), hjust = 1, vjust = 0.5,gp=gpar(fontsize=24))
#dev.off()
...
#jpeg(h=7*i, w=6*i, "figure_sufs_april2025.jpg", units = "in", res=300)
grid.arrange(fruit_map,
             plot_this_legend,
             ggplot(labs2 %>% mutate(xval = c(1)) %>% mutate(yval = (81-c(7,20,32.5,47,59,69.5,78,81))), aes(x = xval, y = yval, shape = location)) +   geom_point(size = 2) + scale_shape_identity() +   theme_cowplot() + theme_void() +  theme(legend.position = "none", axis.title.y = element_text(size = smallsize, face = "bold", angle = 90),plot.tag = element_text(size = tagsize, face = "bold")) +   xlim(c(0.88,1.12)) + ylim(c(-4,84)) + labs(y = "Site", tag = "B"),
             ...
             compost_plot + theme(axis.title = element_text(face = "bold")) + labs(x = NULL) + coord_flip(),
             ggplot(labs2 %>% filter(Geography %in% c("E","H","L")) %>% mutate(xval = c(1)) %>% mutate(yval = (81-c(9,(81/7*3),63))), aes(x = xval, y = yval, shape = location)) +   geom_point(size = 2) + scale_shape_identity() +   theme_cowplot() + theme_void() +  theme(legend.position = "none", axis.title.y = element_text(face = "bold", angle = 90, size = smallsize))+   xlim(c(0.88,1.12)) + ylim(c(-4,84)) + labs(y = "Site"),
             ggplot() + theme_void() + theme(plot.tag = element_text(size = tagsize, face = "bold")) + labs(tag = "D"),
             ggplot() + theme_void() + theme(plot.tag = element_text(size = tagsize, face = "bold")) + labs(tag = "A"),
                          ggplot() + theme_void() + theme(plot.tag = element_text(size = tagsize, face = "bold")) + labs(tag = "C"),

             distance_plot_sufs + labs(x = "Comparison groups"),
             widths = c(0.1,0.1,0.6,0.3,.1,1),
             heights = c(3,1,.5,.5,1.4,3,3),
             layout_matrix=rbind(		
                c(8,1,1,1,3,4),
                c(NA,1,1,1,3,4),
                c(NA,NA,2,NA,3,4),
...
grid.text(c("Comparison","Reference"), x = unit(c(.086,.086), "npc"), y = unit(c(.435,.465), "npc"), hjust = 1, vjust = 0.5,gp=gpar(fontsize=12)) 
...
color_var = "fruittype"
fill_var = "fruittype"
circle_var = "fruittype"
linetype_var = "fruittype"
plot_shapes <- c(rep(15,10))
plot_fills <- c("magenta","grey","black")
plot_colors <- c("magenta","grey","black")
plot_ellipses <- rep(c("solid","solid","solid","solid","solid","solid"),2)
i="weighted_unifrac"
for (i in c("unweighted_unifrac","weighted_unifrac","bray_curtis")) {
  if (i == "unweighted_unifrac") {title_name_add <- "Unweighted Unifrac"
  } else if (i == "weighted_unifrac") {title_name_add <- "Weighted Unifrac"
...
pcoag_cornstageonly_unweighted_unifrac
pcoag_cornstageonly_weighted_unifrac + theme(legend.position = "bottom")
bc_lyman_flies <- pcoag_cornstageonly_bray_curtis + theme(legend.position = "none")
bc_lyman_flies
...
bc_lyman_fruits <- ggplot(uwmpc_all, aes(x = axis1, y = axis2, colour=fruittype, shape=fruittype, fill=fruittype, lty = fruittype)) + 
		geom_point(alpha = 1, size=6, alpha = 0.5, color = "black") + #, shape=plot_shapes, size=3, col=plot_colors) + 
		scale_color_manual(name=NULL, labels=c("Apple","Peach","Pear"), values=c("yellow","green","blue")) + 
		scale_fill_manual(name=NULL, labels=c("Apple","Peach","Pear"), values=c("yellow","green","blue")) + 
		scale_shape_manual(name=NULL,labels=c("Apple","Peach","Pear"), values=rep(21,10)) + 
#	 scale_linetype_manual(name=legend_name[4],labels=legend_label[[4]], values=plot_ellipses) +
	  #		scale_fill_manual(name="Legend", values=c("red","black","white")) +
		theme(panel.background = element_blank(), 
					axis.line = element_line(), 
		...
		labs(x = paste("PCo",pco1," ( ",round(as.numeric(pc_values[pco1]),1),"% )",sep=""), 
				 y = paste("PCo",pco2," ( ",round(as.numeric(pc_values[pco2]),1),"% )",sep=""), 
				 title = NULL) +
#  guides(fill=guide_legend(ncol=4,byrow=F), color=guide_legend(ncol=4,byrow=F), shape=guide_legend(ncol=4,byrow=F)) +
  stat_ellipse(aes(x = axis1, y = axis2, group= fruittype, linetype = "solid"), show.legend = F, type = "t", geom = "polygon", level = 0.7, alpha = 0, inherit.aes=T, lty = 1) 
...
plotvarnames = c("plotorder","orchard_subsite","site","ospo") 
  ## plot by cornstage only
shape_var = "FruitGuess"
color_var = "FruitGuess"
fill_var = "FruitGuess"
circle_var = "FruitGuess"
linetype_var = "FruitGuess"
plot_shapes <- c(rep(16,10))
plot_fills <- c("yellow","orange","black","red","grey","magenta","cyan","green","blue","purple") # c(rep("black",10))
plot_colors <- c("yellow","orange","black","red","grey","magenta","cyan","green","blue","purple") #c(rep("black",10))
plot_ellipses <- rep(c(NULL,NULL,NULL,NULL,NULL,NULL),2)
i="weighted_unifrac"
for (i in c("unweighted_unifrac","weighted_unifrac","bray_curtis")) {
  if (i == "unweighted_unifrac") {title_name_add <- "Unweighted Unifrac"
  } else if (i == "weighted_unifrac") {title_name_add <- "Weighted Unifrac"
  ...
  legend_position = "none"
  folder_name = paste0(file_path,"/",i)
  assign(paste0("pcoag_cornstageonly_",i), pcoa_manyvar_solidlineplot(folder_name=folder_name, mapper_file = mapper_file, title_name_add=title_name_add, legend_position = legend_position, shape_var = shape_var, color_var = color_var, fill_var = fill_var, circle_var = circle_var, linetype_var = linetype_var, plot_shapes = plot_shapes, plot_fills = plot_fills, plot_colors = plot_colors, plot_ellipses = NULL, pco1 =1, pco2=2))
}

bc_lyman_flies <- pcoag_cornstageonly_bray_curtis + theme(legend.position = "none") + geom_point(size = 4)
bc_lyman_flies
...
#pcoa_manyvar_solidlineplot <- function(folder_name = folder_name, mapper_file = mapper_file, title_name_add = title_name_add, legend_position = legend_position,pco1=1,pco2=2,shape_var = shape_var,color_var = color_var,fill_var = fill_var,circle_var = circle_var, linetype_var = linetype_var, plot_shapes = plot_shapes, plot_fills = plot_fills, plot_colors = plot_colors, plot_ellipses = plot_ellipses, circle_color = "black", legend_name = NULL, legend_label = NULL) {
  ...
  varnames <- varnames[!duplicated(varnames)]
	...
	uwmpc_all$FruitGuess <-  factor(uwmpc_all$FruitGuess, levels = c("FJ","BA","CA","CO","LI","MA","OR","PR","RP","SP"))

	uwmpc_all$FruitGuess <-  factor(uwmpc_all$FruitGuess, labels = c("Apple","Banana","Carrot","Corn","Lime","Mango","Orange","Pear","Peach","Spaghetti\nsquash"))
	
bc_lyman_flies <- ggplot(uwmpc_all, aes(x = axis1, y = axis2, colour=FruitGuess, shape=FruitGuess, fill=FruitGuess, lty = FruitGuess)) + 
		geom_point(alpha = 1, size=6, alpha = 0.5, color = "black") + #, shape=plot_shapes, size=3, col=plot_colors) + 
		scale_color_manual(name=NULL, labels=c("Apple","Banana","Carrot","Corn","Lime","Mango","Orange","Pear","Peach","Spaghetti\nsquash"), values=plot_colors) + 
		scale_fill_manual(name=NULL, labels=c("Apple","Banana","Carrot","Corn","Lime","Mango","Orange","Pear","Peach","Spaghetti\nsquash"), values=plot_fills) + 
		scale_shape_manual(name=NULL,labels=c("Apple","Banana","Carrot","Corn","Lime","Mango","Orange","Pear","Peach","Spaghetti\nsquash"), values=rep(21,10)) + 
#	 scale_linetype_manual(name=legend_name[4],labels=legend_label[[4]], values=plot_ellipses) +
	  #		scale_fill_manual(name="Legend", values=c("red","black","white")) +
		theme(panel.background = element_blank(), 
					axis.line = element_line(), 
		...
		labs(x = paste("PCo",pco1," ( ",round(as.numeric(pc_values[pco1]),1),"% )",sep=""), 
				 ...
				 title = NULL) +
#  guides(fill=guide_legend(ncol=4,byrow=F), color=guide_legend(ncol=4,byrow=F), shape=guide_legend(ncol=4,byrow=F)) +
  stat_ellipse(aes(x = axis1, y = axis2, group= FruitGuess, linetype = "solid"), show.legend = F, type = "t", geom = "polygon", level = 0.7, alpha = 0, inherit.aes=T, lty = 1) 


fruits_legend <- g_legend(bc_lyman_flies)
plot(fruits_legend)
...
plot(wf_legend)
i=1.6
#jpeg(h=4*i*1.4, w=13*i, "fig3_may2025.jpg", units = "in", res=300)
grid.arrange(plot1 + labs(tag = "A") + theme(plot.tag = element_text(size = tagsize, face = "bold")) + theme(axis.text.x = element_text(angle = 35, hjust=1, vjust=1)) + labs(x = "Fruit"),
            ggplot() + theme_void(),
             ...
             bc_lyman_fruits + labs(tag = "C") + theme(plot.tag = element_text(size = tagsize, face = "bold"), legend.position = "none", axis.title = element_text(size = 28, face = "bold")),
                         bc_lyman_flies + labs(tag = "D") + theme(plot.tag = element_text(size = tagsize, face = "bold"), legend.position = "none", axis.title = element_text(size = 28, face = "bold")),
...
jpeg(h=8*1.3*i, w=8*i*1.05, "figure_joepiles_april2025.jpg", units = "in", res=300)
grid.arrange(time_plot + labs(x = "Time from pile start (d)", tag = "H", y = "Fractional abundance", title = "Time (pile start date)") + theme(plot.tag = element_text(size = tagsize, face = "bold"), plot.tag.position = NULL, axis.text.x = element_text(size = smallsize), axis.text.y = element_text(size = smallsize), axis.title = element_text(size = smallsize, face = "bold")) + theme(axis.text.x = element_blank(), axis.title.x = element_blank()),
             lineartime_plot + labs(x = "Time from experimental start (d)", tag = "A", y = "Fractional abundance", title = "Time (calendar date)") + theme(plot.tag = element_text(size = tagsize, face = "bold"), plot.tag.position = NULL, axis.text.y = element_text(size = smallsize), axis.title = element_text(size = smallsize, face = "bold"), axis.text.x = element_blank(), axis.title.x = element_blank()) + xlim(c(0,67)),
             time_WUmantel + labs(tag = "I", y = "Microbiota distance\n(weighted Unifrac)", x = "Difference in time (d)") + theme(plot.tag = element_text(size = tagsize, face = "bold"), plot.tag.position = NULL, axis.text = element_text(size = smallsize), axis.title = element_text(size = smallsize, face = "bold")), 
             lineartime_WUmantel + labs(tag = "B",y = "Microbiota distance\n(weighted Unifrac)", x = "Difference in time (d)") + theme(plot.tag = element_text(size = tagsize, face = "bold"), plot.tag.position = NULL, axis.text = element_text(size = smallsize), axis.title = element_text(size = smallsize, face = "bold")),
             lineartime_ancom_glucono  + theme(axis.title.x = element_text(face = "bold", size = smallsize), axis.text.y = element_text(size = smallsize), axis.text.x = element_text(size = smallsize, angle=0)) + xlim(c(0,70)) + stat_smooth(method = "lm", alpha = alphaval, color = "black")+ ggplot2::annotate(geom = "text", x = 5, y = 0.4, hjust=0, label = paste0("S = ",unname(round(pc_label$estimate,2)),"\np =  ", unname(round(pc_label$p.value,4))), size = annotationsize) + theme(plot.tag = element_text(size = tagsize, face = "bold"), plot.tag.position = NULL, axis.title.y = element_text(size = smallsize*.9, face = "bold"))+ labs(tag = "C", title = "Gluconobacter", y = "Fractional abundance", x = "Time (d)") + geom_col(fill = "orange") + theme(plot.title = element_text(face = "bold")),
             lineartime_ancom_entero + labs(tag = "D", title = "Enterobacteriaceae", x = "Time (d)") + theme(axis.title = element_blank(), axis.title.x = element_text(face = "bold", size = smallsize), axis.text.y = element_text(size = smallsize), axis.text.x = element_text(size = smallsize, angle=0)) + xlim(c(0,70)) + stat_smooth(method = "lm", alpha = alphaval, color = "black")+ ggplot2::annotate(geom = "text", x = 60, y = 0.32, hjust=1,  label = paste0("S = ",unname(round(pd_label$estimate,2)),"\np =  ", unname(round(pd_label$p.value,4))), size = annotationsize) + theme(plot.tag = element_text(size = tagsize, face = "bold"), plot.tag.position = NULL)+ geom_col(fill = "darkgreen")+ theme(plot.title = element_text(face = "bold")),
             peachlineartime_ancom_glucono + labs(tag = "F", title = "Gluconobacter", x = "Time (d)") + theme(axis.title = element_blank(), axis.title.x = element_text(face = "bold", size = smallsize), axis.text.y = element_text(size = smallsize), axis.text.x = element_text(size = smallsize, angle=0)) + xlim(c(0,70)) + stat_smooth(method = "lm", alpha = alphaval, color = "black")+ ggplot2::annotate(geom = "text", x = 5, y = 0.5, hjust=0,  label = paste0("S = ",unname(round(pf_label$estimate,2)),"\np = ", unname(round(pf_label$p.value,4))), size = annotationsize) + theme(plot.tag = element_text(size = tagsize, face = "bold"), plot.tag.position = NULL),
             time_ancom_glucono + labs(tag = "J", title = "Gluconobacter", y = "Fractional abundance", x = "Time (d)") + theme(axis.text.x = element_text(size = smallsize), axis.title.x = element_text(size = smallsize, face = "bold"), axis.title.y = element_text(size = smallsize*0.9, face = "bold"))+ geom_col(fill = "orange") + stat_smooth(method = "lm", alpha = alphaval, color = "black")+ ggplot2::annotate(geom = "text",x = 5, y = 0.5, hjust=0, label = paste0("S = ",unname(round(pj_label$estimate,2)),"\np = ", unname(round(pj_label$p.value,2))), size = annotationsize) + theme(plot.tag = element_text(size = tagsize, face = "bold"), plot.tag.position = NULL)+ theme(plot.title = element_text(face = "bold")),
             time_ancom_entero + labs(tag = "K", title = "Enterobacteriaceae", x= "Time (d)") + theme(axis.title.x = element_text(face = "bold", size = smallsize), axis.title.y = element_blank(), axis.text = element_text(size = smallsize))+ geom_col(fill = "darkgreen") + stat_smooth(method = "lm", alpha = alphaval, color = "black")+ ggplot2::annotate(geom = "text", x = 60, y = 0.4, hjust=1,  label = paste0("S = ",unname(round(pk_label$estimate,2)),"\np = ", unname(round(pk_label$p.value,2))), size = annotationsize) + theme(plot.tag = element_text(size = tagsize, face = "bold"), plot.tag.position = NULL)+ theme(plot.title = element_text(face = "bold")),
             peachtime_ancom_glucono + labs(tag = "M", title = "Gluconobacter", x = "Time (d)") + theme(axis.title.y = element_blank(), axis.title.x = element_text(size = smallsize, face = "bold"), axis.text.y = element_text(size = smallsize), axis.text.x = element_text(size = smallsize, angle=0)) + stat_smooth(method = "lm", alpha = alphaval, color = "black") + ggplot2::annotate(geom = "text", x = 5, y = 0.66, hjust=0, label = paste0("S = ",unname(round(pm_label$estimate,2)),"\np =  ", unname(round(pm_label$p.value,2))), size = annotationsize) + theme(plot.tag = element_text(size = tagsize, face = "bold"), plot.tag.position = NULL) + xlim(c(0,70)) + ylim(c(-0.1,.78)),
             ...
             peachlineartime_ancom_lacto + labs(tag = "G", title = "Lactobacillus", x = "Time (d)") + theme(axis.title = element_blank(), axis.title.x = element_text(face = "bold"), axis.text.y = element_text(size = smallsize), axis.text.x = element_text(size = smallsize, angle=0)) + xlim(c(0,70)) + stat_smooth(method = "lm", alpha = alphaval, color = "black")+ ggplot2::annotate(geom = "text", x = 5, y = 0.07, hjust=0,  label = paste0("S = ",unname(round(pg_label$estimate,2)),"\np = ", unname(round(pg_label$p.value,2))), size = annotationsize) + theme(plot.tag = element_text(size = tagsize, face = "bold"), plot.tag.position = NULL),
             peachtime_ancom_lacto + labs(tag = "N", title = "Lactobacillus", x = "Time (d)") + theme(axis.title.y = element_blank(), axis.text.y = element_text(size = smallsize), axis.text.x = element_text(size = smallsize, angle=0), axis.title.x = element_text(face= "bold", size = smallsize)) + xlim(c(0,70)) + ylim(c(-0.02,.18)) + stat_smooth(method = "lm", alpha = alphaval, color = "black")+ ggplot2::annotate(geom = "text", x = 5, y = 0.15, hjust=0,  label = paste0("S = ",unname(round(pn_label$estimate,2)),"\np = ", unname(round(pn_label$p.value,4))), size = annotationsize) + theme(plot.tag = element_text(size = tagsize, face = "bold"), plot.tag.position = NULL),
             lineartime_ancom_leuconostoc + theme(axis.title.x = element_text(face = "bold", size = smallsize), axis.text.y = element_text(size = smallsize), axis.text.x = element_text(size = smallsize, angle=0)) + xlim(c(0,70)) + stat_smooth(method = "lm", alpha = alphaval, color = "black")+ ggplot2::annotate(geom = "text", x = 65, y = 0.18, hjust=1, label = paste0("S = ",unname(round(pe_label$estimate,2)),"\np =  ", unname(round(pe_label$p.value,3))), size = annotationsize) + theme(plot.tag = element_text(size = tagsize, face = "bold"), plot.tag.position = NULL, axis.title.y = element_blank())+ labs(tag = "E", title = "Leuconostoc", x = "Time (d)") + geom_col(fill = "purple1")+ theme(plot.title = element_text(face = "bold")),
             time_ancom_leuconostoc + labs(tag = "L", title = "Leuconostoc", x= "Time (d)") + theme(axis.title.x = element_text(face = "bold", size = smallsize), axis.title.y = element_blank(), axis.text = element_text(size = smallsize))+ geom_col(fill = "purple1") + stat_smooth(method = "lm", alpha = alphaval, color = "black")+ ggplot2::annotate(geom = "text", x = 60, y = 0.1, hjust=1,  label = paste0("S = ",unname(round(pl_label$estimate,2)),"\np = ", unname(round(pl_label$p.value,5))), size = annotationsize) + theme(plot.tag = element_text(size = tagsize, face = "bold"), plot.tag.position = NULL)+ theme(plot.title = element_text(face = "bold")),
...
# Development panel B
```{r, warning=F, message=F}
#setwd('~/Dropbox/Administrative/Meetings/2025-07-LAB/')
...
dev3b <- dev3 %>%
  group_by(location,trt) %>%
  dplyr::summarize(mean = mean(variable), sem = sd(variable)/sqrt(dplyr::n())) %>%
  ungroup()
ggplot(dev3b %>% mutate(location = factor(location, levels = c("pile","top","entrance"), labels = c("square","triangle","circle"))), aes(x = location, y = mean)) + geom_pointrange(aes(ymin = mean-sem, ymax = mean+sem)) + theme_cowplot()
...
ggplot(dev3b %>% mutate(trt = factor(trt, levels = c("pile","fruit"), labels = c("compost","apple"))), aes(x = trt, y = mean)) + geom_pointrange(aes(ymin = mean-sem, ymax = mean+sem)) + theme_cowplot() + labs(x = "Substrate", y = "Development time (d)")
ggsave(h=5, w=3, "Dev_piles.jpg")

getwd()
model_all <- coxme::coxme(S ~ location + (1|experiment),  data = dev3 %>% filter(treatment == "A") %>% mutate(location = factor(location, levels = c("pile","top","entrance"), labels = c("square","triangle","circle"))))
summary(model_all)[[1]]
l1.1 <- glht(model_all, mcp(location = "Tukey"))
p_val1 <- try(summary(l1.1)$test$pvalues[1],T)
cld(l1.1)

model_all <- coxme::coxme(S ~ trt + (1|experiment),  data = dev3 %>% filter(treatment == "A") %>% mutate(trt = factor(trt)))
anova(model_all)
summary(model_all)[[1]]
l1.1 <- glht(model_all, mcp(trt = "Tukey"))
p_val1 <- try(summary(l1.1)$test$pvalues[1],T)
cld(l1.1)
...
```{r, warning=F, message=F}
setwd('~/Dropbox/Working Trade-offs/Gale/sequence_results/')
permanova_name = "conant"
bc_analysis("conant_test1", paste0("cfu_mapper_",permanova_name,".tsv"), "~ Treatment * Sex + exp", permutations = 1000)
bc_analysis("conant_test1", paste0("cfu_mapper_",permanova_name,".tsv"), "~ source/Treatment * Sex + exp", permutations = 1000)
bc_analysis("conant_test1", paste0("cfu_mapper_",permanova_name,".tsv"), "~ source * Sex + exp", permutations = 1000)

make_charts <-readr::read_tsv(file = "https://raw.githubusercontent.com/johnchaston/Gale2024/main/cfu_data.tsv", show_col_types = F) %>% dplyr::rename(`#SampleID` = codename) %>% relocate(`#SampleID`) %>% mutate(source = ifelse(Treatment %in% c("ER","TI","TW"), "apple",ifelse(Treatment %in% c("P19","P20","P21"), "pile","somethingelse"))) %>% filter(total > 2500)

cfu1 <- make_chart_stats_96_bar_jitter_violin(bac = make_charts %>% filter(Sex == "M"), column = "source", plotout = 1, yaxis = NULL, aceto_bottom = F,logplot = F, baradjust = 10000, loglabeladjust = 10,baradjust_bottom = -0, yaxis_perc = c(0,1), perc_errorbars = NULL, add_jitter = T, add_violin = T) +   labs(x = "Diet source", y = "fractional abundance") + theme(legend.position = "none") 
cfu2 <- make_chart_stats_96_bar_jitter_violin(bac = make_charts %>% filter(Sex == "M"), column = "source", plotout = 2, yaxis = NULL, aceto_bottom = F,logplot = F, baradjust = 10000, loglabeladjust = 10,baradjust_bottom = -0, yaxis_perc = c(0,1), perc_errorbars = NULL, add_jitter = T, add_violin = T) +   labs(x = "Diet source", y = "fractional abundance") + theme(legend.position = "none") 
cfu3 <- make_chart_stats_96_bar_jitter_violin(bac = make_charts %>% filter(Sex == "F"), column = "source", plotout = 1, yaxis = NULL, aceto_bottom = F,logplot = F, baradjust = 10000, loglabeladjust = 10,baradjust_bottom = -0, yaxis_perc = c(0,1), perc_errorbars = NULL, add_jitter = T, add_violin = T) +   labs(x = "Diet source", y = "fractional abundance") + theme(legend.position = "none") 
cfu4 <- make_chart_stats_96_bar_jitter_violin(bac = make_charts %>% filter(Sex == "F"), column = "source", plotout = 2, yaxis = NULL, aceto_bottom = F,logplot = F, baradjust = 10000, loglabeladjust = 10,baradjust_bottom = -0, yaxis_perc = c(0,1), perc_errorbars = NULL, add_jitter = T, add_violin = T) +   labs(x = "Diet source", y = "fractional abundance") + theme(legend.position = "none") 

#jpeg(h=8, w=9.5, "pile_cfus.jpg", units = "in", res=300)
grid.arrange(cfu1 + labs(tag = "A") + scale_x_discrete(labels = c("Apple","Compost")),
             cfu2 + labs(tag = "B")+ scale_x_discrete(labels = c("Apple","Compost")),
             cfu3 + labs(tag = "C")+ scale_x_discrete(labels = c("Apple","Compost")),
             cfu4 + labs(tag = "D")+ scale_x_discrete(labels = c("Apple","Compost")),
             widths = c(1,1),
#             heights = c(1,.5,.3,1.2,.8,.75,.8),
             heights = c(1,1),
             layout_matrix=rbind(		
